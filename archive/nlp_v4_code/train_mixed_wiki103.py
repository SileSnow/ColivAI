...
from model_mixed import TransformerLM_Mixed
...
def main():
        ...
        for batch_idx, (inp, tgt) in enumerate(train_loader):
            ...
            if global_step % EVAL_EVERY == 0:
                ...
                if val_ppl < best_val_ppl:
                    ...
                    torch.save(model.state_dict(), MODEL_DIR + "/best_mixed103.pt")
    ...
    with open(LOG_DIR + "/mixed103_pe_params.json", "w") as f:
        json.dump(pe_snapshot, f, indent=2)
    print(f"[PE params saved] {LOG_DIR}/mixed103_pe_params.json")
