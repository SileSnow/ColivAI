"""
V4-RoPE 训练 — LLaMA 风格 + WikiText-103
"""
...
def main():
    ...
    # 模型
    model = TransformerLM_RoPE(VOCAB_SIZE, D_MODEL, NHEAD, NLAYER, D_INTER, MAX_LEN, DROPOUT, PAD_ID).to(device)
        ...
        for batch_idx, (inp, tgt) in enumerate(train_loader):
            ...
            if global_step % EVAL_EVERY == 0:
                ...
                if val_ppl < best_val_ppl:
                    ...
                    torch.save(model.state_dict(), MODEL_DIR + "/best_rope.pt")
